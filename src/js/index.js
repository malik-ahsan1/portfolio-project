function executeCode() {
    ...
    function drawLine(animatedLine, duration = 1.5) {
    ...
    // =============================================================================
    const heroPara = document.querySelectorAll(
    ...
    const topCircleHero = document.querySelector(
        '.circle-area-hero__top-circle'
    );
    ...
    const topCircleIntro = document.querySelector(
        '.circle-area-intro__top-circle'
    );
    ...
    const detectionAreaProjects = document.getElementById(
        'circle-area-projects'
    );
    ...
    let innerContentProjects = document.querySelector(
        '.view-all-projects__text'
    );
    ...
    function mouseleaveProjectsCircle() {
        ...
        // Return to resting position (center)
        gsap.to(
            [topCircleProjects, bottomCircleProjects, innerContentProjects],
            {
                x: 0,
                y: 0,
                duration: 1.5,
    ...
    const detectionAreaMessage = document.getElementById(
        'circle-area-message-me'
    );
    ...
    let innerContentMessage = document.querySelector(
        '.view-all-message-me__text'
    );
    ...
    const animatedLineProjects = document.getElementById(
        'animated-line-projects'
    );
    const animatedLineProjectsTimeline = document.getElementById(
        'animated-line-projects-timeline'
    );
    ...
    const projectsTimelineHeader = document.querySelector(
    ...
    const projectsTimelineContainer = document.querySelector(
        '.projects-timeline-container'
    ); // Not All, Just One

    gsap.to(projectsTimelineContainer, {
        x: '-200%', // animate horizontally
        ease: 'none',
        scrollTrigger: {
            trigger: '.projects-timeline-section', // element that triggers scroll
            start: 'top 20%',
            end: 'top -200%', // scroll distance in pixels (adjust as needed)
            scrub: 2,
            pin: true, // this makes the whole section stay fixed
        },
    });
    ...
    if (!isMobile) {
        const shrinkingBox = document.getElementById('background-wrapper');

        gsap.to(shrinkingBox, {
            left: '50%',
            top: '55%',
            xPercent: -50,
            yPercent: -53,
            ...
            scrollTrigger: {
                ...
                onEnter: () => {
                    console.log('Shrinking box animation started');
                    shrinkingBox.classList.remove('inset-0');
                    shrinkingBox.classList.add(
                        'border-2',
                        'border-white/40',
                        'rounded-5xl'
                    );
                ...
                onUpdate: (self) => {
                    if (self.progress === 0) {
                        setTimeout(() => {
                            shrinkingBox.classList.add('inset-0');
                            shrinkingBox.classList.remove(
                                'border-2',
                                'border-white/40',
                                'rounded-5xl'
                            );
    ...
    window.addEventListener('load', () => {
        ...
        if (isMobile) {
            document
                .querySelector('.stripWrap--touch')
                .classList.add('bottom-64');
        }
        ...
        if (!isMobile) {
            ...
            initializeLine(animatedLineProjectsTimeline);
            drawLine(animatedLineProjectsTimeline);

            initializeHeader(projectsTimelineHeader);
            animateHeader(projectsTimelineHeader);
...
document.addEventListener('ProjectTimelineHtmlInserted', () => {
    executeCode();
});
